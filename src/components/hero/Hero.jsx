...
const heroContent = {
  ...
  heroDescriptions: `At Nerdy Tech Solutions, we are more than just a technology company – we are your dedicated partners in harnessing the power of innovation to bring your ideas to life. Specializing in web-development, app-development, game development, and software development, we pride ourselves on turning your wildest concepts into tangible, functional, and user-centric realities. In a world where technology shapes the future, Nerdy Tech Solutions stands at the forefront of crafting dynamic solutions that transcend the ordinary. Connect with us for more info.`,
  heroBtn: "About Me",
};
